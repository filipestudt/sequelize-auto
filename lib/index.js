    ...
    async.each(_.keys(self.tables), function (table, _callback) {
      ...
      _.each(fields, function (field, i) {
        ...
        _.each(fieldAttr, function (attr, x) {
          ...
          if (attr === "foreignKey") {
            if (isSerialKey) {
              text[table] += spaces + spaces + spaces + spaces + "autoIncrement: true";
            }
            else if (foreignKey.isForeignKey) {
              text[table] += spaces + spaces + spaces + spaces + "references: {\n";
            ...
            if (defaultVal === null || defaultVal === undefined) {
              ...
              text[table] += spaces + spaces + spaces + spaces + attr + ": " + val_text;
            }
          }
      ...
      for (let association of associations) {
        ...
        text[table] += spaces + spaces + "this.belongsTo(models.";
